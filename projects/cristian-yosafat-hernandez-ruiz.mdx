...
authorIds:
  - Cristian Yosafat Hernández Ruiz # Must match your author file name (without .yml)
categories:
...
demoUrl: https://air-translate-c7uoadpid-cristian-yosafat-hernandez-ruiz.vercel.app # Optional: Live demo
